...
const Body = () => {
  const {
    ...
    array: state.array,
    currentBubble: state.bubble,
    currentQuick: state.quick,
    pivot: state.pivot,
    currentSwappers: state.swappers,
    currentHeap: state.heap,
    currentSorted: state.sorted,
    currentMergeX: state.merge,
    currentInsertion:state.insertion,
